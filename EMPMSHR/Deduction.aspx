<%@ Page Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Deduction.aspx.cs" Inherits="EMPMSHR.Deduction" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function LoadAllDeduction() {
            ...
            CallByAjaxWithoutParameter(_PageName, _MethodType, "LoadDeduction", OnSuccessLoadAllData)

        }

        function Edit_Click(DeductionID) {

            
            _DeductionID = DeductionID;
           
            var pval = '{ "PageNo" :"0","RecordPerPage":"12","SortBy":"0","SortAs":"0","SearchBy":"0","SearchVal":"0","Extra" : [{"Pname":"@ID","Pval":"' + _DeductionID + '"}] }';
            //var pval = '{ "ID":"' + DeductionID + '"}';
            alert(pval);
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetDeductionByID", OnSuccessLoadDataForEdit)

           // alert(pval);
           // alert(333);
        }

        function Delete_Click(DeductionID) {
           
            var pval = '{ "ID":"' + DeductionID + '"}';
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "DeleteDeduction", OnSuccessSave);
            //  LoadDepartment();
        }
        ...
        function BtnSave_OnClick() {
            ...
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "DeductionAdd", OnSuccessSave);
        ...
        function BtnEditSave_OnClick() {
            ...
            var pval = '{"ID" :"' + _DeductionID + '", "Name" :"' + $('#TxtdprtName').val() + '"}';
            
            var sd = JSON.parse(pval);
            sd = JSON.parse(pval);
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "EditDeduction", OnSuccessSave)
            // LoadDepartment();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivAddN" style="display:none">
        ...
        <div class="panel-heading">Deduction Add</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="text-right">
                            <button type="button" class="btn btn-danger btn-sm" onclick="LoadDeduction()" ><i class="glyphicon glyphicon-refresh"></i></button>
                        </div>
                    </div>
                </div>
                </div>
