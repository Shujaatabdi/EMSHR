<%@ Page Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Designation.aspx.cs" Inherits="EMPMSHR.Designation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        var _PageName = "Designation.aspx";
        ...
        var _Rowcount = "0";
        var PageCount = "0";
        var _MethodName = LoadDesignation;
        ...
        function LoadDesignation() {
            ...
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetDesignationForPaging", OnSuccessLoadData)
           
        }
        function LoadAllDesignation()
        {
            CallByAjaxWithoutParameter(_PageName, _MethodType, "LoadDesignation", OnSuccessLoadAllData)

        }

        function Edit_Click(DesignationID) {

            //alert(ShftID);
            _DesignationID = DesignationID;
           
            var pval = '{ "PageNo" :"0","RecordPerPage":"12","SortBy":"0","SortAs":"0","SearchBy":"0","SearchVal":"0","Extra" : [{"Pname":"@ID","Pval":"' + DesignationID + '"}] }';
            //var pval = '{ "ID":"' + DepartmentID + '"}';
           
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetDesignationByID", OnSuccessLoadDataForEdit)

           // alert(pval);
           // alert(333);
        }

        function Delete_Click(DesignationID) {
           
            var pval = '{ "ID":"' + DesignationID + '"}';
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "DeleteDesignation", OnSuccessSave);
            //  LoadDepartment();
        }
        ...
        function BtnSave_OnClick() {
            alert(1);
            var pval = '{ "BranchID" :"' + $('#TxtBranchID').val() + '","Name":"' + $('#TxtdprtName').val() + '"}';
          
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "DesignationAdd", OnSuccessSave);
        ...
        function BtnEditSave_OnClick() {
            ...
            var pval = '{"ID" :"' + _DesignationID + '","BranchID" :"' + $("#TxtBranchID").val() + '", "Name" :"' + $('#TxtdprtName').val() + '"}';
           
            var sd = JSON.parse(pval);
            sd = JSON.parse(pval);
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "EditDesignation", OnSuccessSave)
            // LoadDepartment();
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br /><br />
    <div class="panel">
        <div><input type="button" id="BtnAddnew" onclick="BtnAddNew_OnClick()" class="btn btn-primary" value="Add New" /><input type="button" id="BtnViewComapny" onclick="    BtnViewComapny_OnClick()" class="btn btn-primary" value="View Designation" /></div>
    ...
    <div id="DivAddN" style="display:none">
        ...
        <div class="panel-heading">Designation Add</div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 text-right">
                            ...
                            <button class="btn btn-success" type="button" id="BtnEditSave" onclick="BtnEditSave_OnClick()">Update &nbsp<i class="glyphicon glyphicon-edit"></i></button>
                             <button class="btn btn-danger" type="button" id="BtnCancel" onclick="BtnCancel_OnClick()">Cancel &nbsp<i class="glyphicon glyphicon-remove"></i></button>
                            </div>
                    </div>
                </fieldset>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="text-right">
                            <button type="button" class="btn btn-danger btn-sm" onclick="LoadDesignation()" ><i class="glyphicon glyphicon-refresh"></i></button>
                        </div>
                    </div>
                </div>
                </div>
