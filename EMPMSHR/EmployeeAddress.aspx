<%@ Page Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EmployeeAddress.aspx.cs" Inherits="EMPMSHR.EmployeeAddress" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        var _PageName = "EmployeeAddress.aspx";
        var _MethodType = "POST";
        var _EmployeeAddressID;
        var _Sorting = "1";
        var _SortAs = "Asc";
        var _RecordPP = "10";
        var _PageNo = "1";
        ...
        var _Rowcount = "0";
        var PageCount = "0";
        var _MethodName = LoadEmployeeAddress;

        function LoadEmployeeAddress() {
            alert(1);
            ...
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetEmployeeAddressForPaging", OnSuccessLoadData)

        }
        function LoadAllEmployeeAddress() {
            CallByAjaxWithoutParameter(_PageName, _MethodType, "LoadEmployeeAddress", OnSuccessLoadAllData)


        }

        function Edit_Click(EmployeeAddressID) {

            //alert(ShftID);
            _EmployeeAddressID = EmployeeAddressID;

            var pval = '{ "PageNo" :"0","RecordPerPage":"12","SortBy":"0","SortAs":"0","SearchBy":"0","SearchVal":"0","Extra" : [{"Pname":"@ID","Pval":"' + EmployeeAddressID + '"}] }';
            //var pval = '{ "ID":"' + EmployeeAddressID + '"}';

            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetEmployeeAddressByID", OnSuccessLoadDataForEdit)


        }

        function Delete_Click(EmployeeAddressID) {

            _EmployeeAddressID = EmployeeAddressID;
            var pval = '{ "ID":"' + EmployeeAddressID + '"}';
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "DeleteEmployeeAddress", OnSuccessSave);
          //  LoadEmployeeAddress();
        }
        ...
        function BtnSave_OnClick() {
            ...
            var pval = '{ "EmployeeID" :"' + $('#TxtEmpID').val() + '","Address":"' + $('#TxtAddress').val() + '","Phone1":"' + $('#TxtPh1').val() + '","Phone2":"' + $('#TxtPh2').val() + '"}';

            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "EmployeeAddressAdd", OnSuccessSave);
        ...
        function BtnEditSave_OnClick() {
            ...
            var pval = '{"ID" :"' + _EmployeeAddressID + '","EmployeeID" :"' + $("#TxtEmpID").val() + '", "Address" :"' + $('#TxtAddress').val() + '","Phone1":"' + $('#TxtPh1').val() + '","Phone2":"' + $('#TxtPh2').val() + '"}';
            alert(pval);
            var sd = JSON.parse(pval);
            sd = JSON.parse(pval);
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "EditEmployeeAddress", OnSuccessSave)
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br /><br />
    <div class="panel">
        <div><input type="button" id="BtnAddnew" onclick="BtnAddNew_OnClick()" class="btn btn-primary" value="Add New" /><input type="button" id="BtnViewComapny" onclick="    BtnViewComapny_OnClick()" class="btn btn-primary" value="View EmployeeAddress" /></div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-4">
                                    <select id="CboSb" class="form-control input-sm">
                                        ...
                                        <option value="3">EmployeeAddress Type
                                        </option>
                                    </select>
                                </div>
                                <div class="col-lg-5">
    ...
    <div id="DivAddN" style="display:none">
        ...
        <div class="panel-heading">EmployeeAddress Add</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="text-right">
                            <button type="button" class="btn btn-danger btn-sm" onclick="LoadEmployeeAddress()" ><i class="glyphicon glyphicon-refresh"></i></button>
                        </div>
                    </div>
                </div>
                </div>
