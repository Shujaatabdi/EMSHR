<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="EMPMSHR.AddCompany" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function Edit_Click(CompID)
        {
            _CompID=CompID;
            var pval = '{ "PageNo" :"0","RecordPerPage":"12","SortBy":"0","SortAs":"0","SearchBy":"0","SearchVal":"0","Extra" : [{"Pname":"@CompID","Pval":"' + CompID + '"}] }';
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "GetCompForEdit", OnSuccessLoadDataForEdit)
            
        }

        function Delete_Click(CompID)
        {
            var pval = '{ "ID":"' + CompID + '"}';
        ...
        function BtnSave_OnClick()
        {
            ...
            var pval = '{ "Name" :"' + $('#TxtName').val() + '","Address":"' + $('#TxtAddress').val() + '"}';
           // var sd = json.parse(pval);
            CallByAjaxWithParameter("data", pval, _PageName, _MethodType, "Add", OnSuccessSave)
        ...
        { 
            var pval = "{'ID':'" + _CompID + "', 'Name' :'" + $('#TxtName').val() + "','Address':'" + $('#TxtAddress').val() + "'}";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br /><br /><br />
    <div class="panel">
        <div><input type="button" id="BtnAddnew" onclick="BtnAddNew_OnClick()" class="btn btn-primary" value="Add New" /><input type="button" id="BtnViewComapny" onclick="BtnViewComapny_OnClick()" class="btn btn-primary" value="View Companies" /></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-11">
                        <div class="text-right">
                            <button type="button" class="btn btn-danger btn-sm" onclick="LoadCompany()" ><i class="glyphicon glyphicon-refresh"></i></button>
                        </div>
                    </div>
                </div>
                </div>
